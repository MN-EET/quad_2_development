...
def fetch_miso_hourly(eia_key: str, destdir: str):
    ...
    feb_url = "https://api.eia.gov/v2/electricity/rto/region-data/data/?api_key=" + eia_key + "&frequency=hourly&data[0]=value&facets[respondent][]=MISO&facets[type][]=D&start=" + query_year + "-02-01T00&end=" + query_year + "-02-29T00&sort[0][column]=period&sort[0][direction]=asc&offset=0&length=5000"
